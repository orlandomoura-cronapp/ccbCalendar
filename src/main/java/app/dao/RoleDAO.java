...
public interface RoleDAO extends JpaRepository<Role, RolePK> {
  ...
  public Role findOne(@Param(value="id") java.lang.String id, @Param(value="user_id") java.lang.Integer user_id);
  ...
  public void delete(@Param(value="id") java.lang.String id, @Param(value="user_id") java.lang.Integer user_id);
  ...
  public Page<Role> findRolesByUser(@Param(value="id") java.lang.Integer id, Pageable pageable);
