...
public interface EstadoDAO extends JpaRepository<Estado, java.lang.Integer> {
   ...
   * @generated
   */
  @Query("SELECT entity FROM User entity WHERE entity.estado.id = :id AND (entity.email like concat('%',coalesce(:search,''),'%') OR entity.name like concat('%',coalesce(:search,''),'%') OR entity.login like concat('%',coalesce(:search,''),'%'))")
   ...
   * @generated
   */
  @Query("SELECT entity FROM User entity WHERE entity.estado.id = :id AND (:email is null OR entity.email like concat('%',:email,'%')) AND (:name is null OR entity.name like concat('%',:name,'%')) AND (:login is null OR entity.login like concat('%',:login,'%'))")
   ...
   * @generated
   */
  @Query("SELECT entity FROM igreja entity WHERE entity.estado.id = :id AND (entity.nome like concat('%',coalesce(:search,''),'%') OR entity.horarioEnsaio like concat('%',coalesce(:search,''),'%'))")
   ...
   * @generated
   */
  @Query("SELECT entity FROM igreja entity WHERE entity.estado.id = :id AND (:nome is null OR entity.nome like concat('%',:nome,'%')) AND (:horarioEnsaio is null OR entity.horarioEnsaio like concat('%',:horarioEnsaio,'%'))")
   ...
   * @generated
   */
  @Query("SELECT entity FROM Estado entity WHERE entity.nome like concat('%',coalesce(:search,''),'%')")
   ...
   * @generated
   */
  @Query("SELECT entity FROM Estado entity WHERE (:nome is null OR entity.nome like concat('%',:nome,'%'))")
  public Page<Estado> specificSearch(@Param(value="nome") java.lang.String nome, Pageable pageable);
