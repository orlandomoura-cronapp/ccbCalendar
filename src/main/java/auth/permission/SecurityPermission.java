...
public class SecurityPermission implements Permission {
  ...
  public static final String DEPART_MUSICAL = "Departamento Musical";

  public static final String ENC_LOCAL = "Encarregado Local";

  public static final String ENC_REGIONAL = "Encarregado Regional";

  public static final String MUSICO_ORGANISTA = "Músico / Organista";

  public static final String ROLE_ADMIN_NAME = "Administrators";

  public static final String SUBDEPARTAMENTO = "Subdepartamento";
